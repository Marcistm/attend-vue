...
const store = new Vuex.Store({
    state:{
        ...
        table:[
            {role:0,item:[{name:'首页',id:'1'},{name:'请假',id:"2"},{name:'离校申请',id:'3'},{name:'返校申请',id:'4'},{name:'健康档案',id:'5'}, {name:'每日健康申报',id:'6'},{name:'核酸记录',id:'7'},{name:'上课签到',id:'19'},{name:'我的通知',id:'20'}]},
        ...
        tableData:[
            ...
            {name:'通知管理',table:'notice',column:[{label:'id',name:'id',show:false},{label:'时间',name:'time',show:true},{label:'内容',name:'text',show:true},{label:'班级',name:'class',show:true},{label:'发布人',name:'author',show:true}]},
            ...
            {name: '班级管理',table: 'class',column: [{label: 'id',name:'id',show:false},{label: '班级',name:'class'},{label: '班主任',name:'username'}]}
        ],
        data:[],
        stu_info:{}
    },
